...
class MaskRCNN:
    def __init__(self):
        # Loading Mask RCNN
        self.net = cv2.dnn.readNetFromTensorflow("assets/dnn/frozen_inference_graph_coco.pb",
                                            "assets/dnn/mask_rcnn_inception_v2_coco_2018_01_28.pbtxt")
                                            # "dnn/mscoco_label_map.pbtxt")
        ...
        self.classes = []
        with open("assets/dnn/classes.txt", "r") as file_object:
